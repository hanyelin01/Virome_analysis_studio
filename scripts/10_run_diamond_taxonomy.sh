...
OUT="$OUTPUT_DIR/02_diamond_nr_taxonomy"; HITS="$OUT/nr_virus_hits.outfmt6.tsv"; TAXIDS="$OUT/query_taxids.tsv"; LCA="$OUT/query_lca.tsv"; LINEAGE="$OUT/query_lca_lineage.tsv"; SUMMARY="$OUT/contig_taxonomy_lca.tsv"
if [[ -s $SUMMARY ]]; then
